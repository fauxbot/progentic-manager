...
- Read `requirements.md` for new or unprocessed requirements.
...
6. Mark processed requirements in `requirements.md` by adding `<!-- processed -->` after each converted line.
